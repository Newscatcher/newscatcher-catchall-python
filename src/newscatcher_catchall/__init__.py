...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "BasicAuthDto": ".types",
    "BasicAuthResponseDto": ".types",
    "BearerAuthDto": ".types",
    "BearerAuthResponseDto": ".types",
    "CatchAllApi": ".client",
    ...
    "WebhookHistoryResourceType": ".types",
    "WebhookPayload": ".types",
    "WebhookResourceMappingResponseDto": ".types",
    "WebhookResponseDto": ".types",
    "WebhookResponseDtoAuth": ".types",
    "WebhookResponseDtoAuth_ApiKey": ".types",
    "WebhookResponseDtoAuth_Basic": ".types",
    "WebhookResponseDtoAuth_Bearer": ".types",
    "WebhookType": ".types",
    "__version__": ".version",
    "datasets": ".datasets",
    "entities": ".entities",
