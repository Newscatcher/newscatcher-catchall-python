...
from newscatcher_catchall.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from newscatcher_catchall.core.request_options import RequestOptions
...
@patch("newscatcher_catchall.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("newscatcher_catchall.core.http_client.asyncio.sleep", new_callable=AsyncMock)
